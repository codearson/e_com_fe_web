...
export const Navbar = () => {
  ...
  const categories = [
    ...
    { name: 'Men', icon: <svg className="w-5 h-5 inline mr-2 text-[#1E90FF]" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M16 7a4 4 0 1 1-8 0 4 4 0 0 1 8 0zM12 11v7m-4 0h8" /></svg> },
    { name: 'Designer', icon: <svg className="w-5 h-5 inline mr-2 text-[#1E90FF]" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M12 2l4 4-4 4-4-4z" /></svg> },
    { name: 'Kids', icon: <svg className="w-5 h-5 inline mr-2 text-[#1E90FF]" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><circle cx="12" cy="8" r="4" /><path d="M6 22v-2a4 4 0 0 1 8 0v2" /></svg> },
    { name: 'Home', icon: <svg className="w-5 h-5 inline mr-2 text-[#1E90FF]" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M3 12l9-9 9 9" /><path d="M9 21V9h6v12" /></svg> },
    { name: 'Electronics', icon: <svg className="w-5 h-5 inline mr-2 text-[#1E90FF]" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><rect x="2" y="7" width="20" height="14" rx="2" /><path d="M16 3v4M8 3v4" /></svg> },
    { name: 'Entertainment', icon: <svg className="w-5 h-5 inline mr-2 text-[#1E90FF]" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10" /><path d="M8 15l4-4-4-4" /></svg> },
    ...
    <nav className="bg-white border-b border-gray-200 font-sans sticky top-0 z-50">
      ...
      <div className="flex items-center justify-between px-4 py-3 lg:px-8 lg:py-3">
        ...
        <div className="flex items-center">
          <span className="text-2xl lg:text-3xl font-semibold text-[#1E90FF] mr-4 select-none" style={{ fontFamily: 'cursive' }}>
            E-Com
          </span>
        </div>
        ...
        <div className="lg:hidden flex-1 mx-4">
          <div className="flex items-center bg-gray-100 rounded-md">
            <svg className="w-5 h-5 ml-3 text-gray-500" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
        ...
        <div className="hidden lg:flex flex-1 max-w-4xl mx-8">
          <div className="flex items-center flex-1 bg-gray-100 rounded-md">
            <svg className="w-5 h-5 ml-4 text-gray-500" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
            </svg>
            <input
              type="text"
        ...
        >
          <svg className="w-6 h-6 text-[#1E90FF]" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
      ...
      <div className="border-t border-gray-300 hidden lg:flex items-center space-x-8 px-12 py-2 text-black text-base font-normal overflow-x-auto">
        {['Women', 'Men', 'Designer', 'Kids', 'Home', 'Electronics', 'Entertainment', 'Sports', 'Pet care', 'About', 'Our Platform'].map((item) => (
          <button key={item} className="hover:text-[#1E90FF] transition-colors cursor-pointer whitespace-nowrap">{item}</button>
        ))}
      </div>
        ...
        <>
          ...
          <aside className="fixed top-0 left-0 w-full h-full bg-white z-50 shadow-lg flex flex-col transition-transform duration-300 transform translate-x-0">
            <div className="flex items-center justify-between px-4 py-4 border-b">
              <span className="text-2xl font-semibold text-[#1E90FF] select-none" style={{ fontFamily: 'cursive' }}>E-Com</span>
              <button 
            ...
            <div className="px-4 py-3 text-sm font-medium text-gray-600">Categories</div>
