    ...
    <div className="max-w-7xl mx-auto px-4 py-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
        ...
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li><a href="#" className="hover:underline">Item Verification</a></li>
            <li><a href="#" className="hover:underline">Mobile apps</a></li>
            <li><a href="#" className="hover:underline">Infoboard</a></li>
          </ul>
        </div>
        <div>
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6 border-t pt-6">
        <div className="flex items-center space-x-4 mb-2 md:mb-0">
          ...
          {/* Instagram */}
          <a href="#" className="hover:opacity-70">
            <svg className="w-7 h-7" fill="none" stroke="#bdbdbd" strokeWidth="1.5" viewBox="0 0 24 24">
              <rect x="2.5" y="2.5" width="19" height="19" rx="5" stroke="#bdbdbd" strokeWidth="1.5" fill="none"/>
              <circle cx="12" cy="12" r="5" stroke="#bdbdbd" strokeWidth="1.5" fill="none"/>
        ...
        <div className="flex items-center space-x-4">
          ...
          <a href="#" className="block">
            <img src="/src/assets/apple.svg" alt="Download on the App Store" className="h-10 w-auto" />
          </a>
          <a href="#" className="block">
            <img src="/src/assets/google.svg" alt="Get it on Google Play" className="h-10 w-auto" />
          </a>
        </div>
      </div>
      {/* Bottom: Policy Links */}
